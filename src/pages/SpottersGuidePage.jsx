...
function SpottersGuidePage({
  ...
  async function toggleFavorite(
    ...
    const isAlreadyFavorite =
      activeFavorites.includes(
        driverName,
      );

    let updatedSeriesFavorites;

    if (isAlreadyFavorite) {
      updatedSeriesFavorites =
      ...
      if (
        ...
        setFavoriteMessage(
          "You can favorite up to three drivers in this series.",
        );
